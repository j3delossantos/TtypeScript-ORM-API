...
var createProperty = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newProperty, results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newProperty = typeorm_1.getRepository(Property_1.Property).create(req.body);
                return [4 /*yield*/, typeorm_1.getRepository(Property_1.Property).save(newProperty)];
            case 1:
                results = _a.sent();
